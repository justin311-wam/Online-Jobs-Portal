...
<head>
	...
	<title>Justin Jobs - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Kasarani, <br/> PO.BOX 1173, <br/>Hunters Road</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:justinwambua311@gmail.com">justinwambua311@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+254742218971">+254742218971</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Jobs is a job portal, online job management system developed by Justin Wambua for his project in November 2025.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : Kasarani,Hunters road PO.BOX 1123</p>
								<p>Email : <a href="mailto:justinwambua311@gmail.com">justinwambua311@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">+254742218971</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> Justin Wambua Software</p>
...
<a href="twitter.com" target="_blank" class="fa fa-twitter"></a>
